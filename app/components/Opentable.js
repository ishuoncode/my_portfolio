...
import {  UnchiudaanFeatures } from '@/constant/data';
    ...
    >
      ...
      <div className="h-[400px]  lg:flex">
        <div className="mt-[-80px] lg:flex-1">
          ...
          <Link href="https://unchiudaanclasses.com/">
            <button
          ...
          <div className=" mt-[100px] w-[100%] lg:ml-[0px] lg:mt-[0px] lg:max-w-max-content xl:ml-[18%] lg:absolute lg:right-[6%]">
            {windowWidth < 990 ? (
              <motion.div variants={fadeIn('right', 'tween', 0.2, 1)}>
                <Image
                  src={`/assest/unchi-${changeImageNumber}.png`}
                  alt={`unchi-${changeImageNumber}`}
                  height={700}
                  width={500}
