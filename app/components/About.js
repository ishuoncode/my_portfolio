...
export default function About() {
  return (
    <>
      <div className=" absolute   sm:left-[52%] left-[-6%] sm:top-[40%] top-[41%] z-0 h-[50vh] w-[204px] rotate-[-53.13deg] bg-[#2d4898bf] blur-[200px] lg:left-[60%] lg:top-[21%] lg:h-[70vh] lg:w-[300px]"></div>
      <motion.div
